...
<div class="menu">
    ...
    <form action="cancelauction" method="post">
        <input id="id" type="text" class="form-control" placeholder="ID" name="Id" required/><br>
        <input type="submit" class="btn btn-primary" method="execute" value="Cancel Auction">
    </form>
